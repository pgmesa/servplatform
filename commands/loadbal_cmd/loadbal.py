...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
def loadbal(args:list=[], options:dict={}, flags:list=[], nested_cmds:dict={}):
    if "add" in nested_cmds:
        ...
        rm(**cmd_info)
    elif "set" in nested_cmds:
        cmd_info = nested_cmds.pop("set")
        set_(**cmd_info)
    elif "reset" in nested_cmds:
        cmd_info = nested_cmds.pop("reset")
        reset(**cmd_info)
